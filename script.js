$(document).ready(function() {
  const apiRoot = 'https://taskapplication2.onrender.com/v1/tasks';
  const trelloApiRoot = 'https://taskapplication2.onrender.com/v1/trello';
  ...
  function handleCardCreationRequest(event) {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        alert('Card created: ' + (data.shortUrl || 'No URL returned'));
        console.log(data);
      }
    });
  }
